...
file = './BCST_NASDAQCOMP_SR/';
load('NASDAQcomp.mat'); %stock price matrix(685 weeks)
wk_return_d1 = Assets_Returns(1:684, :)'; % 共28支股票，去掉最后一周
wk_return_b1 = Index_Returns(1:684, :)';
rf_00_17=load('rf_03_16.txt',','); %risk free
...
ratiot_yearly = ratio_p_all* (N/13.25)^0.5; %bsct NASDAQCOMP数据集 
