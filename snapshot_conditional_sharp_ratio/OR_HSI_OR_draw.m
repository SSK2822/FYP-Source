...
filedir1_OR_HSI = './OR_HSI_CSR/';
filelist1_OR_HSI = dir([filedir1_OR_HSI, '*.txt']);
filedir2_OR_HSI = './OR_HSI_CSR_rho/';
filelist2_OR_HSI = dir([filedir2_OR_HSI, '*.txt']);
...
for i = (N/2+1):N
    ...
    filename1 = filelist1_OR_HSI(i-N/2);
    filename2 = filelist2_OR_HSI(i-N/2);

    x_solution = load(['./OR_HSI_CSR/',filename1.name]);
    xt_all(:, i-N/2) = x_solution;
    rho_solution = load(['./OR_HSI_CSR_rho/',filename2.name]);
