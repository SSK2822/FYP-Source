...
filedir1 = './BCST_SP500_CSR/';
filelist1 = dir([filedir1, '*.txt']);
filedir2 = './BCST_SP500_CSR_rho/';
...
rf_92_97=load('rf_04_16b.txt',','); %risk free
...
for i = (N/2+1):N
    ...
    x_solution = load(['./BCST_SP500_CSR/',filename1.name]);
    xt_all(:, i-N/2) = x_solution;
    rho_solution = load(['./BCST_SP500_CSR_rho/',filename2.name]);
