...
filedir1 = './UPDATE_HSCI_CSR/';
filelist1 = dir([filedir1, '*.txt']);
filedir2 = './UPDATE_HSCI_CSR_rho/';
...
for i = (N/2+1):N
    ...
    x_solution = load(['./UPDATE_HSCI_CSR/',filename1.name]);
    xt_all(:, i-N/2) = x_solution;
    rho_solution = load(['./UPDATE_HSCI_CSR_rho/',filename2.name]);
