...
ylabel('PR$_{\rm \bf a}$vs PR$_{\rm \bf p}$', 'interpreter', 'latex', 'fontsize', fontsize_label)   ;
title('DownJones'); 
hold on
...
saveas(gcf, [filefigures, 'NEW_DJIA_PR'], 'eps');
saveas(gcf, [filefigures, 'NEW_DJIA_PR'], 'png');
