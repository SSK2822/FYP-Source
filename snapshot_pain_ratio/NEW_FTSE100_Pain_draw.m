...
for i = (N/2+1):N 
    ...
    evar0 = Pain_Var_p(i-N/2, wk_return_d1, xt_all);
    ...
    ratio_a_my = My_wk_rt_a_temp / Pain_Var_a(i, wk_return_d1, xt);
    esr_a(i-N/2) = ratio_a_my;

    %equally weighted
    ew_wk_rt_temp = x_ew' * wk_return_d1_test - rf;
    ew_wk_rt(i-N/2) = ew_wk_rt_temp;
    ratio_ew = sum(ew_wk_rt) / (i-N/2) / Pain_Var_p(i-N/2, wk_return_d1, x_ew_all);
...
for i = N/2+1:N
    ...
    evar_index = Pain_Var_p_index(i-N/2, wk_return_b1);
    esr_index(:, i-N/2) = index_wk_rt / (i-N/2) / evar_index;
end
disp("Index Ended")
disp("MV Started")
ratio_p_all_yearly = ratio_p_all* (N/13.83)^0.5;
ac_wk_rt_yearly = ac_wk_rt * (N/13.83)^0.5;
...
for ii = (N/2+1):N 
    ...
    evar0 = Pain_Var_p(ii-N/2, wk_return_d1, xt_mv_all);
...
for ii = (N/2+1):N 
    ...
    My_wk_rt(ii-N/2) = My_wk_rt_temp;
    evar0 = Pain_Var_p(ii-N/2, wk_return_d1, xt_lssd_all);
    ratio_my = sum(My_wk_rt) / (ii-N/2) / evar0;
...
for ii = (N/2+1):N 
    ...
    My_wk_rt(ii-N/2) = My_wk_rt_temp;
    evar0 = Pain_Var_p(ii-N/2, wk_return_d1, xt_lrassd_all);
    ratio_my = sum(My_wk_rt) / (ii-N/2) / evar0;
...
for ii = (N/2+1):N 
    ...
    My_wk_rt(ii-N/2) = My_wk_rt_temp;
    evar0 = Pain_Var_p(ii-N/2, wk_return_d1, xt_rmzssd_all);
    ratio_my = sum(My_wk_rt) / (ii-N/2) / evar0;
...
for ii = (N/2+1):N 
    ...
    My_wk_rt(ii-N/2) = My_wk_rt_temp;
    evar0 = Pain_Var_p(ii-N/2, wk_return_d1, xt_kpssd_all);
    ratio_my = sum(My_wk_rt) / (ii-N/2) / evar0;
...
for ii = (N/2+1):N 
    ...
    My_wk_rt(ii-N/2) = My_wk_rt_temp;
    evar0 = Pain_Var_p(ii-N/2, wk_return_d1, xt_czesd_all);
    ratio_my = sum(My_wk_rt) / (ii-N/2) / evar0;
