...
for week = (num_weeks/2+1):num_weeks 
    ...
    portfolio_weights = load(['./UPDATE_SP500_Calmar/',filename.name]);
...
saveas(gcf, [filefigures, 'UPDATE_SP500_CR'], 'eps');
saveas(gcf, [filefigures, 'UPDATE_SP500_CR'], 'png');