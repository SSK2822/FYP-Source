...
for week = (num_weeks/2+1):num_weeks 
    ...
    portfolio_weights = load(['./UPDATE_HDAX_Martin/',filename.name]);
...
saveas(gcf, [filefigures, 'UPDATE_HDAX_MR'], 'eps');
saveas(gcf, [filefigures, 'UPDATE_HDAX_MR'], 'png');