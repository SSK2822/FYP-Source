...
for week = (num_weeks/2+1):num_weeks 
    ...
    portfolio_weights = load(['./UPDATE_FTSE_Martin/',filename.name]);
...
saveas(gcf, [filefigures, 'UPDATE_FTSE_MR'], 'eps');
saveas(gcf, [filefigures, 'UPDATE_FTSE_MR'], 'png');