...
for week = (num_weeks/2+1):num_weeks 
    ...
    portfolio_weights = load(['./UPDATE_HSCI_Martin/',filename.name]);
...
saveas(gcf, [filefigures, 'UPDATE_HSCI_MR'], 'eps');
saveas(gcf, [filefigures, 'UPDATE_HSCI_MR'], 'png');