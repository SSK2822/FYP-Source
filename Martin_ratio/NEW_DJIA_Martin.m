...
% Calculate annualized Martin ratio for test data using different factors depending on the dataset
Martin_ratio_annualized_or = Martin_ratio_p_all* (num_weeks/5.5)^0.5;
Martin_ratio_annualized_update = Martin_ratio_p_all* (num_weeks/18)^0.5;
Martin_ratio_annualized_bsct_DJIA = Martin_ratio_p_all*(num_weeks/26.25)^0.5;
Martin_ratio_annualized_bsct_NASDAQ100 = Martin_ratio_p_all* (num_weeks/11.5)^0.5;
Martin_ratio_annualized_bsct_FTSE100 = Martin_ratio_p_all* (num_weeks/13.83)^0.5;
