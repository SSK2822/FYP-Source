...
risk_free_rate=load('rf_90_16.txt',','); %risk free
...
ratio_yearly = ratio * (num_weeks/26.25)^0.5;
ratio_ew_yearly = ratio_ew * (num_weeks/26.25)^0.5;

ratio_index_yearly = ratio_index * (num_weeks/26.25)^0.5;
ratio_mv_yearly = ratio_mv * (num_weeks/26.25)^0.5;
ratio_lssd_yearly = ratio_lssd * (num_weeks/26.25)^0.5;
ratio_lrassd_yearly = ratio_lrassd * (num_weeks/26.25)^0.5;
ratio_rmzssd_yearly = ratio_rmzssd * (num_weeks/26.25)^0.5;
ratio_kpssd_yearly = ratio_kpssd * (num_weeks/26.25)^0.5;
ratio_czesd_yearly = ratio_czesd * (num_weeks/26.25)^0.5;
...
saveas(gcf, [filefigures, 'NEW_DJIA_MR'], 'eps');
saveas(gcf, [filefigures, 'NEW_DJIA_MR'], 'png');
