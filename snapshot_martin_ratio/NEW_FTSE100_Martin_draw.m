...
rf_04_16=load('rf_02_16.txt',','); %risk free
...
for i = (N/2+1):N 
    ...
    evar0 = Martin_Var_p(i-N/2, wk_return_d1, xt_all);
...
for ii = (N/2+1):N 
    ...
    evar0 = Martin_Var_p(ii-N/2, wk_return_d1, xt_mv_all);
...
for ii = (N/2+1):N 
    ...
    My_wk_rt(ii-N/2) = My_wk_rt_temp;
    evar0 = Martin_Var_p(ii-N/2, wk_return_d1, xt_lssd_all);
    ratio_my = sum(My_wk_rt) / (ii-N/2) / evar0;
...
for ii = (N/2+1):N 
    ...
    My_wk_rt(ii-N/2) = My_wk_rt_temp;
    evar0 = Martin_Var_p(ii-N/2, wk_return_d1, xt_lrassd_all);
    ratio_my = sum(My_wk_rt) / (ii-N/2) / evar0;
...
for ii = (N/2+1):N 
    ...
    My_wk_rt(ii-N/2) = My_wk_rt_temp;
    evar0 = Martin_Var_p(ii-N/2, wk_return_d1, xt_rmzssd_all);
    ratio_my = sum(My_wk_rt) / (ii-N/2) / evar0;
...
for ii = (N/2+1):N 
    ...
    My_wk_rt(ii-N/2) = My_wk_rt_temp;
    evar0 = Martin_Var_p(ii-N/2, wk_return_d1, xt_kpssd_all);
    ratio_my = sum(My_wk_rt) / (ii-N/2) / evar0;
...
for ii = (N/2+1):N 
    ...
    My_wk_rt(ii-N/2) = My_wk_rt_temp;
    evar0 = Martin_Var_p(ii-N/2, wk_return_d1, xt_czesd_all);
    ratio_my = sum(My_wk_rt) / (ii-N/2) / evar0;
