...
for week = (num_weeks/2+1):num_weeks 
    ...
    portfolio_weights = load(['./UPDATE_FTSE_Calmar/',filename.name]);
...
saveas(gcf, [filefigures, 'UPDATE_FTSE_CR'], 'eps');
saveas(gcf, [filefigures, 'UPDATE_FTSE_CR'], 'png');