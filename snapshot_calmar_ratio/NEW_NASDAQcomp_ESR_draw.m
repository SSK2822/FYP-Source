...
filedir = './NEW_NASDAQcomp_ESR/';
filelist = dir([filedir, '*.txt']);
rhodir = './NEW_NASDAQcomp_ESR_rho/';
...
rf_03_16=load('rf_03_16.txt',','); %risk free
rt_test = rf_03_16(N/2+1:N);
...
%}
esr_yearly = esr * (N/13.25)^0.5;
esr_ew_yearly = esr_ew * (N/13.25)^0.5;
%{
