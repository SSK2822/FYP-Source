...
asset_returns = Assets_Returns(1:716, :)';
index_returns = Index_Returns(1:716, :)';

% Get number of assets and weeks
[num_assets, num_weeks] = size(asset_returns);

% Set output file path
output_file = './NEW_FTSE100_Calmar/';

% Load risk-free rate data
risk_free_rate = load('rf_02_16.txt',',');
...
% Calculate Calmar ratio for test data using different factors depending on the dataset
calmar_ratio_bsct_FTSE100 = calmar_ratio_p_all* (num_weeks/13.83)^0.5;
